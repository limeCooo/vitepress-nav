...
log('zhangsan', 1, 2) // zhangsan [1, 2]
log('zhangsan', 1, 2, 3) // zhangsan [1, 2, 3]
```
...
// 字符串会以字符数组的形式做合并
Object.assign({}, 'zhangsan') // {0: 'm', 1: 'a', 2: 'o', 3: 'm', 4: 'a', 5: 'o'}
...
Object.values(obj) //  ['zhangsan', 18]
Object.entries(obj) // [['name', 'zhangsan'], ['age', 18]]
```
...
```js
Object.fromEntries([['name', 'zhangsan']]) // {name: 'zhangsan'}

/* Map 转对象 */
const map = new Map([['name', 'zhangsan']])
Object.fromEntries(map) // {name: 'zhangsan'}

/* 将查询字符串转为对象 */
const params = 'name=zhangsan&age=18'
Object.fromEntries(new URLSearchParams(params)) // {name: 'zhangsan', age: '18'}
```
